...
async function main() {
  ...
  const dbCards = await Promise.all([
    prisma.card.create({
      data: {
        ...
        attackPoints: 9500,
        defensePoints: 8200,
        imageUrl: "https://example.com/goku.jpg&quot",
    ...
    prisma.card.create({
      data: {
        ...
        attackPoints: 9000,
        defensePoints: 8500,
        imageUrl: "https://example.com/vegeta.jpg&quot",
        collectionId: dragonBall.id,
      },
    }),
    prisma.card.create({
      data: {
        ...
        attackPoints: 9200,
        defensePoints: 9000,
        imageUrl: "https://example.com/jiren.jpg&quot",
        collectionId: dragonBall.id,
      },
    }),
  ]);
  ...
  const narutoCards = await Promise.all([
    prisma.card.create({
      data: {
        ...
        attackPoints: 8700,
        defensePoints: 7600,
        imageUrl: "https://example.com/naruto.jpg&#39/",
    ...
    prisma.card.create({
      data: {
        ...
        attackPoints: 8500,
        defensePoints: 8000,
        imageUrl: "https://example.com/sasuke.jpg&#39",
        collectionId: naruto.id,
      },
    }),
    prisma.card.create({
      data: {
        ...
        attackPoints: 7500,
        defensePoints: 7200,
        imageUrl: "https://example.com/kakashi.jpg&#39",
        collectionId: naruto.id,
      },
    }),
  ]);
  ...
  console.log(
  'Seed concluída! Criadas ${await prisma.collection.count()} coleções e ${await prisma.card.count()} cards.'
  );
}
